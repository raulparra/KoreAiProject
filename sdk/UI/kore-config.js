(function(KoreSDK){
    ...
    botOptions.userIdentity = 'carnalachon@gmail.com';// Provide users email id here
    botOptions.botInfo = { name: "KoreAiProject", "_id": "st-d2733e1d-b5b8-5474-89ef-ee28c36d1a3a" }; // bot name is case sensitive
    botOptions.isAnonymous = false;
    /* 
    Important Note: These keys are provided here for quick demos to generate JWT token at client side but not for Production environment.
    Refer below document for JWT token generation at server side. Client Id and Client secret should maintained at server end.
    https://developer.kore.ai/docs/bots/sdks/user-authorization-and-assertion/
    **/
    botOptions.clientId = "cs-e5abdd8d-a0da-53d6-ac45-29e8fc098d1a";
    botOptions.clientSecret = "20LHonKhxnbB+eCaZyBa1LL2J2UWd7ciYdXnkeRW1yY=";
